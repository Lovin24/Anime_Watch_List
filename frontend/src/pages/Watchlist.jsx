            ...
            <>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-2">
                      Your Collection ({animeList.length} of {animeList.length})
                    </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {animeList.map((anime) => (
                  <div
                    key={anime._id}
                    className="group relative bg-[#23242b] rounded-2xl overflow-hidden border-2 border-[#181a20] hover:border-[#ffd700] transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex flex-col"
                  >
                    ...
                    {editingAnimeId === anime._id ? (
                      <form
                        className="flex flex-col gap-3 bg-[#23242b] rounded-xl p-4 mt-2"
                        onSubmit={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <select
                          ...
                          className="w-full p-2 rounded-lg bg-[#23242b] text-white border border-[#333] focus:outline-none focus:ring-2 focus:ring-yellow-400"
                        >
                        ...
                        <div className="flex gap-2 mt-2">
                          <button
                            type="submit"
                            className="flex-1 px-4 py-2 rounded-full bg-green-500 text-white font-bold hover:bg-green-600 active:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-green-300"
                          >
                            Save
                          </button>
                          <button
                            ...
                            className="flex-1 px-4 py-2 rounded-full bg-[#444] text-white font-bold hover:bg-[#666] active:bg-[#333] transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400"
                          >
                            Cancel
                          </button>
                        </div>
